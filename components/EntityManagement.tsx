                            ...
                            <div key={dept.id} className="flex justify-between items-center py-2 border-b last:border-b-0">
                                ...
                                {canEdit && (
                                    <div className="space-x-2">
                                        <button onClick={() => handleEditDept(dept)} className="text-indigo-600 hover:text-indigo-900 text-sm">Editar</button>
                                        <button onClick={() => deleteDepartment(dept.id)} className="text-danger hover:text-red-800 text-sm">Excluir</button>
                                    </div>
                                )}
                            </div>
                        ))}
